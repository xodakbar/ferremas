...
SECRET_KEY = 'django-insecure-^o!f02-e-p9u!w+eoc218$v%ifo)^pdoygt-hong0vkaoy$eao'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://postgres:dYLRTgdKROhCoDSwkaQRZxCEYLAjEzYr@switchyard.proxy.rlwy.net:38201/railway',
        conn_max_age=600,
        ssl_require=True
    )
